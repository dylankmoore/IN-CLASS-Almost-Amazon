...
const addAuthorForm = (uid, obj = {}) => {
  clearDom();
  const domString = `
    <form id="${obj.firebaseKey ? `update-author--${obj.firebaseKey}` : 'submit-author'}" class="mb-4 flex-column">
      ...
      <label class="form-check-label" for="favorite">Favorite?</label></div>
